...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE, LPSTR lpCmdLine, int)
{
    ...
    winClass.lpszClassName = L"D3D9TexQuadSM2WindowClass";
    ...
    GetOutputPath("dx9_textured_quad_sm2.bmp", bmpPath, MAX_PATH);
    ...
    fprintf(stderr, "TEST textured_quad_sm2: %s\n", pass ? "PASS" : "FAIL");
